...
public class HakkaKeyboard extends Keyboard {
    private static final String TAG = HakkaKeyboard.class.getSimpleName();
    ...
    public HakkaKeyboard(Context context, int xmlLayoutResId) {
