package com.ngaifa.hakka.about;
...
public class AboutActivity extends MaterialAboutActivity {
    ...
    protected MaterialAboutList getMaterialAboutList(@NonNull Context context) {
        ...
        feedbackCardBuilder.addItem(new MaterialAboutActionItem.Builder()
                ...
                .setOnClickListener(ConvenienceBuilder.createWebsiteOnClickAction(this, Uri.parse("https://play.google.com/store/apps/details?id=com.ngaifa.hakka")))
                .build());
